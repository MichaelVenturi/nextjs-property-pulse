...
const PropertyEditForm = ({ property }) => {
  const updatePropertyById = updateProperty.bind(null, property._id); // this is why updateProperty couldnt be an arrow
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          ...
          <div>
            <input
              ...
              className="mr-2"
              defaultChecked={property.amenities.includes("Wheelchair Accesible")}
            />
          ...
          <div>
            <input
              ...
              className="mr-2"
              defaultChecked={property.amenities.includes("Gym/Fitness")}
            />
